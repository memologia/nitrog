...
class NitroGen:
    ...
    def main(self):
        ...
        if os.name == "nt": 
            print("")
            ctypes.windll.kernel32.SetConsoleTitleW("Nitro Generator and Checker - Made by Imagine")
        else:
...
╚═╝╚═╝     ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝╚═╝  ╚═══╝╚══════╝
                                                        ...
                                                        """) 
        time.sleep(2)
        self.slowType("Made by Imagine", .03)
        time.sleep(1)
        ...
        for i in range(num):
            ...
            if os.name == "nt":
                ctypes.windll.kernel32.SetConsoleTitleW(f"Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by Imagine")
                print("")
            else:
